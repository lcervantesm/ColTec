...
export default ({
  ...
  const defaultPlans = [
    ...
    },
    {
      ...
      durationPrices: ["$1,500", "$16,200"],
      mainFeature: "Formación para la actualidad.",
      features: ["Licenciaturas con aval de la SEP", "Licenciaturas con aval del IPN"],
      featured: true
    },
    {
      name: "Maestrías desde",
      durationPrices: ["$2,000", "$24,000"],
      mainFeature: "Especialización para los dedicados.",
      features: ["Ciencias de la Educación", "Administración de Hospitales"],
      featured: true
    }
  ];
            ...
            <Plan key={index} featured={plan.featured}>
              <PlanHeader>
                <span className="priceAndDuration">
                  <span className="price orange-text">{plan.durationPrices[activeDurationIndex]}</span>
