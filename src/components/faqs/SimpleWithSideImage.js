...
export default ({
  subheading = "",
  heading = "Preguntas",
  description = "Aquí puedes encontrar algunas de las preguntas más frecuentes. Siéntete libre de contactarnos por el formulario que se encuentra más abajo.",
  ...
  const defaultFaqs = [
    ...
    },
    {
      ...
      answer:
        "Tenemos programas en línea que nos permiten borrar barreras de tiempo y espacio para llegar a todo México. Asimismo, tenemos dos planteles ubicados al sur de la Ciudad de México en Iztapalapa y Coapa."
    },
    {
