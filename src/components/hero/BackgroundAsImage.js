...
//import BgCtm from "../../images/alumnas-ctm.png"
...
const Container = styled.div`
  ...
  background-image: url("https://i.ibb.co/s9rkC62/alumnas-ctm.jpg");
`;
  ...
  return (
    <Container>
      ...
      <HeroContainer>
        ...
        <TwoColumn>
          <LeftColumn>
            <Notification>Tenemos un atractivo programa de becas.</Notification>
            <Heading>
              <span>Para avanzar</span>
              <br />
              <SlantedBackground className="orange-text">Hay que empezar.</SlantedBackground>
            </Heading>
            <PrimaryAction className="orange-text">Elige tu programa</PrimaryAction>
          </LeftColumn>
          <RightColumn>
